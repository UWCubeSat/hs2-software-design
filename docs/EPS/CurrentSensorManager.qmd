...
| `CURRENT_SENSOR_SET_REG16` | regAddr (INA3221Reg), mask (U16) | Read-modify-write: register OR mask |
| `CURRENT_SENSOR_CLEAR_REG16` | regAddr (INA3221Reg), mask (U16) | Read-modify-write: register AND NOT mask |
