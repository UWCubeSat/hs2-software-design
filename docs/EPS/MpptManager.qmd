...
| `MPPT_SET_REG8` | regAddr (BQ25756Reg8), mask (U8) | Read-modify-write: register OR mask |
| `MPPT_CLEAR_REG8` | regAddr (BQ25756Reg8), mask (U8) | Read-modify-write: register AND NOT mask |
| `MPPT_WRITE_REG16` | regAddr (BQ25756Reg16), value (U16) | Write to a 16-bit register |
| `MPPT_SET_REG16` | regAddr (BQ25756Reg16), mask (U16) | Read-modify-write: register OR mask |
| `MPPT_CLEAR_REG16` | regAddr (BQ25756Reg16), mask (U16) | Read-modify-write: register AND NOT mask |
...
##### 3.4 Telemetry {.unnumbered .unlisted}
