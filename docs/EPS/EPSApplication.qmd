...
**EPS software topology**:

![EPS application topology diagram](../../EPS/images/EPSApplicationTopology.png){width=100%}
...
- `MpptManager`, `CurrentSensorManager`, `WatchdogPinger`, and `DeployPanelsManager` are all instantiated within the EPS subtopology. `EPSApplication` is health-monitored; the hardware managers are not.
