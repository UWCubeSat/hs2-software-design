...
#### 1.1 Terminology {.unnumbered .unlisted}
| Term | Definition |
|------|------------|
...
##### 3.2.1 `BEACON` Mode {.unnumbered .unlisted}
...
##### 3.2.2 `STANDARD_DOWNLINK` mode {.unnumbered .unlisted}
...
##### 3.2.3 `STORED_PLAYBACK` mode {.unnumbered .unlisted}
...
##### 3.2.4 `NO_DOWNLINK` mode {.unnumbered .unlisted}
...
##### 3.4 ComApplication Telemetry {.unnumbered .unlisted}
...
##### 3.5 ComApplication Events {.unnumbered .unlisted}
...
#### 5. Telemetry Groups {.unnumbered .unlisted}

[TBD] on Telemetry Groups.

#### 6. Communications Connections {.unnumbered .unlisted}
...
##### 6.1 TmtcRadioManager Connections {.unnumbered .unlisted}

![TmtcRadioManager Connections](../../Comms/images/comStubConnections.png)
...
##### 6.2 Uplinked Data Connection Route {.unnumbered .unlisted}
The following diagrams detail the route of downlink data through the port topology of the software subsystems.

##### 6.2.1 Receiving data from Transceiver {.unnumbered .unlisted}
The following diagrams outline the 
![ComStubFramerConnections](../../Comms/images/ComStubFramerConnections.png)
...
##### 6.2.2 FrameAccumulator {.unnumbered .unlisted}
...
##### 6.2.3 Command Dispatching {.unnumbered .unlisted}
...
##### 6.2.4 Uplinked Files {.unnumbered .unlisted}
...
##### 6.3 Downlinked Data Connection Route {.unnumbered .unlisted}
The following diagrams detail the route of downlink data through the port topology of the software subsystems.

##### 6.3.1 Events and Telemetry Packets {.unnumbered .unlisted}
...
##### 6.3.2 Downlinked Files {.unnumbered .unlisted}
...
##### 6.3.3 Downlink Framing {.unnumbered .unlisted}
...
##### 6.3.4 TmtcRadioManager Downlink {.unnumbered .unlisted}
![ComStubFramerConnections](../../Comms/images/ComStubFramerConnections.png)
...
##### 6.4 Communication Security {.unnumbered .unlisted}
