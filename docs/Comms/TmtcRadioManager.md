...
#### 3.2 Communication Adapter Interface {.unnumbered .unlisted}
...
##### 3.2.1 Communication Queue Protocol {.unnumbered .unlisted}
...
##### 3.2.2 Communication Framer Protocol {.unnumbered .unlisted}
