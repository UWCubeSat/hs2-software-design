...
HuskySat-2 uses external C++ libraries for the optical-navigation and star-catalog processing mission. The libraries are invoked by `ScienceInferenceApplication` rather than by drivers or hardware managers.
